...
output_file = open("Financial_Details.txt","w+")
output_file.write("Financial Details")
output_file.write("\n")
output_file.write("________")
output_file.write("\n")
output_file.write("Total Months: " + str(total_months))
output_file.write("\n")
output_file.write("Average Revenue: " + str(average_revenue))
output_file.write("\n")
output_file.write("Greatest Increase in Profits: " + str(max_date) +": " + str(max_change))
output_file.write("\n")
output_file.write("Greatest Decrease in Profits: " + str(min_date) +": "+ str(min_change))
output_file.write("\n")
output_file.write("________")
